...
if __name__ == '__main__':
    ...
    save_metric_file_path = "Saved_metrics_data/" + model_name
    output_folder= "Saved_depth_data/" + model_name
    vis_folder = 'Saved_visulaization/' + model_name + "/"
    # step2: 运行脚本
    ...
    if param['is_save_metric']:
        ...
        save_results_to_excel(results, save_metric_file_path, model_name)
    if is_visualize:
        visualize_and_save_images(tgt_images, gt_images, pred_images, output_folder)
